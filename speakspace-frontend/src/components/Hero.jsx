...
const Hero = () => {
  ...
  return (
    <div className="bg-gradient-to-b pt-[20px] from-gray-950 via-gray-900 to-gray-950 text-white min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-500/5 rounded-full filter blur-3xl animate-pulse"
        ...
        ></div>
        <div
          className="absolute bottom-1/4 left-1/3 w-12 h-12 bg-blue-400/20 rounded-lg transform rotate-12 animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center w-full max-w-4xl mx-auto mt-32">
        ...
        <div
          className={`mt-8 relative z-10 transition-all duration-1000 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
      ...
      <div
        className={`mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl relative z-10 transition-all duration-1000 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-center space-x-4 z-10">
        ...
        <div
          className="w-20 h-20 bg-gradient-to-br from-cyan-300/20 to-blue-400/20 rounded-full animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="w-16 h-16 bg-gradient-to-br from-blue-400/20 to-teal-400/20 rounded-lg transform -rotate-12 animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
      </div>
      ...
      <footer className="mt-20 text-center text-gray-500 text-sm relative z-10">
        <p className="pb-1">
          © {new Date().getFullYear()} SpeakSpace. All rights reserved. Built by
          Diet Coders.
        </p>
      </footer>
    </div>
