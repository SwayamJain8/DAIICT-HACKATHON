...
const Register = () => {
  ...
  return (
    <div className="min-h-screen pt-30 bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl shadow-2xl border border-gray-700/50 w-full max-w-md relative z-10">
        ...
        <p className="text-gray-400 text-center mt-6">
          ...
          <Link to="/login" className="text-teal-400 hover:text-teal-300 transition-colors duration-300 font-medium">
            Login here
          </Link>
        </p>
      </div>
