...
const Register = () => {
  ...
  return (
    <div className="min-h-screen pt-[130px] bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center px-6 relative overflow-hidden">
