    ...
    <div className="min-h-screen pt-30 bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white p-6 pt-20 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl shadow-2xl border border-gray-700/50">
          ...
          <p className="text-gray-300 text-center mb-8">You're about to join: <span className="font-medium text-teal-400">{session.topic}</span></p>
          
          <div className="bg-gray-700/30 p-6 rounded-lg mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-bold text-teal-400 mb-2">Session Details</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Topic:</span>
                    <span className="text-gray-300 font-medium">{session.topic}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Duration:</span>
                    <span className="text-gray-300 font-medium">{session.duration} minutes</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Session Code:</span>
                    <span className="text-gray-300 font-medium">{session.sessionCode}</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div>
                <h3 className="text-lg font-bold text-teal-400 mb-2">What to Expect</h3>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-teal-400 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
